  ...
  <header class="header">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="Formations.html">Mon parcours</a>
        </li>

        <li class="nav-item">
          <a class="nav-link active" href="Experiences.html">Mes expériences</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="Interets.html">Mes centres d'intérêts</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="SkillsLang.html">Compétences & Linguistique</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="MeContacter.html">Me contacter</a>
        </li>
