...
<div class="card-deck w-responsive text-center mx-auto mt-5">
  ...
  <div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <h4 class="card-title cyan-text">Français</h4>
      <!--Text-->
      <p class="card-text white-text">Langue native que je maîtrise donc à 100%, bien qu'il reste toujours impossible de maîtriser une langue à la perfection.</p>
  ...
  <div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <h4 class="card-title cyan-text">Anglais</h4>
      <!--Text-->
      <p class="card-text white-text">Langue que je maitrîse très bien (presque bilingue) et que j'ai pu consolider lors de mes études à l'étranger.</p>
  ...
  <div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <h4 class="card-title cyan-text">Espagnol</h4>
      <!--Text-->
      <p class="card-text white-text">Langue dans laquelle de très bonnes bases sont acquises, mais que je ne pratique plus assez malheureusement.</p>
...
<div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
  ...
  <div class="card-body">
    ...
    <!--Title-->
    <h4 class="card-title cyan-text">C/C++/Java</h4>
    <!--Text-->
    <p class="card-text white-text">Trois language de programmation que je matrise correctement, particulièrement le C et C++, et que j'ai développé pendant mes années d'études.</p>
...
<div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
  ...
  <div class="card-body">
    ...
    <!--Title-->
    <h4 class="card-title cyan-text">HTML/CSS/Php</h4>
    <!--Text-->
    <p class="card-text white-text">Language web que je matrise correctement, à voir le résultat de mon site. J'ai également développé des connaissances en BDD sql.</p>
...
<div class="card mb-5 zoom" style="background-color:rgba(0, 0, 0, 0.3);">
  ...
  <div class="card-body">
    ...
    <!--Title-->
    <h4 class="card-title cyan-text">Pack Office</h4>
    <!--Text-->
    <p class="card-text white-text">J'ai également une maitrise du pack office, plus particulièrement en PPT et Word, bien qu'excel ne me fasse pas peur !</p>
